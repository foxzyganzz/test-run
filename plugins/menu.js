...
┃
┃⬡ Script by FoxzyWasHere
┃⬡ Github Name : foxzyganzz
┃⬡ Yt : Foxzy Mods
┃⬡ Run bot : Heroku
┃⬡ Tipe SC FOXZY BOTZ
┗━━━━━━━━⬣`.trim(),
    ...
    // await conn.send3ButtonLoc(m.chat, await (await fetch(`https://i.ibb.co/fH0hppT/mikey.jpg`)).buffer(), text.trim(), 'Recoded By FoxzyWasHere', 'Pemilik Bot', '.owner', 'Donasi', '.donasi', 'Rules', '.infobot', m)
