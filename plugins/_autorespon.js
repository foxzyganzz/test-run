    ...
    try {
        if (m.mentionedJid.includes(this.user.jid) && m.isGroup) {
            await this.send2Button(m.chat,
                isBanned ? `${namabot} tidak aktif` : banned ? 'kamu dibanned' : `${namabot} disini, Halo Kak Ada Yang Bisa Saya Bantu?BTW ini Foxzy Botz V2 ya Foxzy ON 2 Bot untuk bot satunya: wa.me/6285779167354 ON 24 JAM SEMUA`,
                footer,
